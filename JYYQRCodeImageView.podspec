#
#  Be sure to run `pod spec lint JYYQRCodeImageView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/justyoyo/JYYQRCodeImageView"
  ...
  s.source       = { :git => "https://github.com/justyoyo/JYYQRCodeImageView.git", :tag => "1.0.3" }
